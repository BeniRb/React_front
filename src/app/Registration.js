...
const Registration = () => {
  ...
  return (
    <div align="center">
            ...
            <button onClick={() =>{setTimeout(function() {window.location.replace('https://react-front.onrender.com');}, 2000)
            ;dispatch(doSignupAsync({ username: newUserName, password: newPwd, email: newEmail }))}}>Register</button>
            </form>
        </div>
  )
}
